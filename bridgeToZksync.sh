...
# Script that deploys contracts to Sepolia and ZkSync Sepolia and bridges funds between them

# Define constants 
AMOUNT=100000

# https://docs.chain.link/ccip/directory/testnet/chain/ethereum-testnet-sepolia-zksync-1
